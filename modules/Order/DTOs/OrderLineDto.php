...
readonly class OrderLineDto
{
    ...
    /**
     * @return array<array-key, \Modules\Order\DTOs\OrderLineDto> $orderLines
     */
    public static function fromEloquentCollection(Collection $orderLines): array
    {
        return $orderLines->map(fn (OrderLine $orderLine) => self::fromEloquentModel($orderLine))->toArray();
    }
}
